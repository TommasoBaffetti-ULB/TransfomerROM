...
def main(verbose=False):
    ...
    CAEenc = ConvEncoderst(
        model_config["CAEst"]["spatial_conv_config"],
        model_config["CAEst"]["temporal_conv_config"],
    )
    CAEdec = ConvDecoderst(
        model_config["CAEst"]["spatial_tconv_config"],
        model_config["CAEst"]["temporal_tconv_config"],
        model_config["CAEst"]["no_flatten_dim"],
    )

    CAEmodel = CAEst(CAEenc, CAEdec).to(train_config["CAE"]["device"])
    if verbose:
        print("model \n", CAEmodel, "\n")
